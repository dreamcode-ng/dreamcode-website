...
function OurDreamcoders( { withButton = false, text, title  }) {
  return (
    
    <ContainerSection>
        <ContainerCircule className={style.infoCardWithImage}>
          <div className={`${style.banner_container} ${withButton ? style.about : style.index } d-flex position-relative w-100 z-index-9`}>
